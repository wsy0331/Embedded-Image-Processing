...
image = cv2.imread("./Hw1/image.jpeg") 
...
hough_circles = cv2.HoughCircles(canny_image,cv2.HOUGH_GRADIENT,dp=1.3,minDist=30,param1=300,param2=30,minRadius=6,maxRadius=20)
